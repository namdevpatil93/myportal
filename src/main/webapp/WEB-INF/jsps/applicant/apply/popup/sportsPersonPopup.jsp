...
<div class="modal fade" id="sportsPersonModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" data-dismiss="modal" onclick="selectNoAsOption('5')"><fmt:message key="popup.disagree"/></button>
            </div>
        </div>
	</div>
</div>
