...
<div class="modal fade" id="maharashtraDomiciledModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body container-fluid">
            	<div class="row">
            		<div class="col-sm-12">
						<fmt:message key="maharashtra.domicile.no.popup.text"/>
					</div>
            	</div>
            	<br>
            </div>
