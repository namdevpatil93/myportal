...
<div class="applied">
	<div class="row">
		<div class="col-xs-8">
			...
			<fmt:message key="post.security.inspector.junior" />
		</div>
		<div class="col-xs-4">
...
<div class="postalinfo">
	<form class="form-horizontal">
		<table style="width:100%">
			<tr>
				<th style="width:25%">
					<label><fmt:message key="securityInspector.graduateFromAffiliatedInstitute"/>:</label>
				</th>
				<td style="width:25%">
					...
					<c:if test="${ applicantPostAssoc.graduateFromAffiliatedInstitute eq true }">
						<th style="width:25%">
							<label><fmt:message
									key="securityInspector.graduateFromAffiliatedInstitute.degreeName" />:</label>
						</th>
						<td style="width:25%">
			...
			<tr>
				<c:if test="${ applicantPostAssoc.graduateFromAffiliatedInstitute eq true  }">
						<th style="width:25%">
							<label><fmt:message	key="securityInspector.graduateFromAffiliatedInstitute.universityName" />:</label>
						</th>
						<td style="width:25%">
			...
			<tr>
				<th style="width:25%">
					<label><fmt:message
							key="securityInspector.mscitOrGaccc" />:</label>
				</th>
				<td style="width:25%">
				...
				<th style="width:25%">
					<label><fmt:message key="securityInspector.heightWithinRange" />:</label>
				</th>
				<td style="width:25%">
