	...
	<div class="row">
		<div class="col-xs-8">
			<strong><fmt:message key="paymentResponse.postAppliedFor" />
				:</strong>
			<fmt:message key="post.deputyEquipmentEngineer" />
		</div>
		<%-- <div class="col-xs-4">
...
<table style="width:100%">
			<tr>
				<th style="width:25%">
					<label><fmt:message key="deputy.equipment.engineer.isdegree"/>:</label>
				</th>
				<td style="width:25%">
						<c:choose>
							<c:when test="${ applicantPostAssoc.automobileOrMechanicalEngDegree eq true}">
								<label>
									<fmt:message key="yes" />
								</label>
							</c:when>
			...
			<c:if test="${ applicantPostAssoc.automobileOrMechanicalEngDegree eq true}">
				<tr>	<th style="width:25%">
						<label><fmt:message
								key="deputy.equipment.engineer.degreeName" />:</label>
					</th>
					<td style="width:25%">
