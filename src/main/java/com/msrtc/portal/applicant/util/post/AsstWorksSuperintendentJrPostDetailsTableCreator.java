...
public class AsstWorksSuperintendentJrPostDetailsTableCreator {
	private UndertakingDTO dto;

    public AsstWorksSuperintendentJrPostDetailsTableCreator(UndertakingDTO dto){
        this.dto = dto;
    }
	public Table create() {
        ...
        Cell cellOtherQualificationDetails = null;
        if(dto.getOtherQualificationDetails() != null) {
        	cellOtherQualificationDetails = PDFUtil.createDataCell(dto.getOtherQualificationDetails());
        } else {
        	cellOtherQualificationDetails = PDFUtil.createDataCell("");
        }
        table.addCell(cellOtherQualificationDetails);*/
