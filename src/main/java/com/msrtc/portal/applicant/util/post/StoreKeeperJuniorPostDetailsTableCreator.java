...
public class StoreKeeperJuniorPostDetailsTableCreator {
	private UndertakingDTO dto;

    public StoreKeeperJuniorPostDetailsTableCreator(UndertakingDTO dto){
        this.dto = dto;
    }
    ...
    public Table create() {
       ...
       /* table.addCell(PDFUtil.createBoldDataCell("अतिरिक्त शैक्षणिक माहिती:"));
        ...
        table.addCell(PDFUtil.createBoldDataCell("मोटारीचे सुटे भाग इ. भांडार सामान हाताळणे व त्याच्या नोंदी ठेवणे व खरेदी करण्याबाबतचा १ वर्षाचा व्यवहारीक अनुभव. (रा.प. कर्मचाऱ्यांसाठी कनिष्ठ लिपिक पदातील भांडार खात्यातील कामाचा १ वर्षाचा अनुभव ग्राह्य राहील.):"));
