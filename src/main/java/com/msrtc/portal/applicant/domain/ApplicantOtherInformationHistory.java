 ...
 @Entity
 @Table(name = "applicant_other_information_history")
 public class ApplicantOtherInformationHistory implements Serializable{
 ...
 /*	public LocalDateTime getCreatedDate() {
     ...
     public String toString() {
     	...
     	sb.append(", applicantId='").append(applicant).append('\'');
