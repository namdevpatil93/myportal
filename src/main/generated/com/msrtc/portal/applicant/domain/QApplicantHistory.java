...
/**
 * QApplicantHistory is a Querydsl query type for ApplicantHistory
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QApplicantHistory extends EntityPathBase<ApplicantHistory> {

    private static final long serialVersionUID = 278509806L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QApplicantHistory applicantHistory = new QApplicantHistory("applicantHistory");
    ...
    public QApplicantHistory(String variable) {
        this(ApplicantHistory.class, forVariable(variable), INITS);
    }

    public QApplicantHistory(Path<? extends ApplicantHistory> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QApplicantHistory(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QApplicantHistory(PathMetadata metadata, PathInits inits) {
        this(ApplicantHistory.class, metadata, inits);
    }

    public QApplicantHistory(Class<? extends ApplicantHistory> type, PathMetadata metadata, PathInits inits) {
